...
Documentation lives here, versioned with the code it describes. The GitHub wiki
is deliberately disabled: docs that drift from the commit they document are
worse than no docs.
